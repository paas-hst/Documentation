...
A接收B、C、D三路视频，分辨率都是属于720P及以下，计费时长为：60 * 3 = 180分钟，因此费用为：0.024 * 180 = 4.32元；B接收A、C、D三路视频，其中A的分辨率面积属于720P以上，计费时长为：60分钟，费用为：0.072 * 60 = 4.32，C和D的分辨率面积都属于720P及以下，计费时长为：60 * 2 = 120分钟，费用为：0.024 * 120 = 2.88元，因此B的合计费用为：4.32 + 2.88 = 7.2元；C、D的费用与B一样，不再重复计算，因此，总费用为：4.32 + 7.2 * 3 = 25.92元。  
