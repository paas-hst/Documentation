...
## 云录制
云录制的计费分为录制、存储和流量三部分，录制部分计费从录制开始到录制结束，存储部分的计费和存储空间大小和时长相关，流量部分的计费和下载和点播所产生的流量相关。其中录制部分费用又分基础录制费用，每方录制费用和流量费用，资源拉取费用为录制过程中拉取音频、视频、屏幕共享等媒体所产生的费用。存储空间计费取每天峰值空间占用，按天进行计费。
